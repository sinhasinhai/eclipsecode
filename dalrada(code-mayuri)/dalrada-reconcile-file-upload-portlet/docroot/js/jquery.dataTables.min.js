...
(function(za, O, l) {
    var N = function(h) {
            ...
            for (f = a.aoData.length; d < f; d++)
                if (h = a.aoData[d], !h._aFilterData) {
                    ...
                    for (g = b.length; e < g; e++)
                        if (c = b[e], c.bSearchable ? (i = A(a, d, e, "filter"), i = m[c.sType] ? m[c.sType](i) : null !== i ? i : "") : i = "", i) i.indexOf && -1 !== i.indexOf("&") && (qa.innerHTML = i, i = Wb ? qa.textContent : qa.innerText), i.replace && (i = i.replace(/[\r\n]/g, "")), j.push(i);
                    h._aFilterData = j;
        ...
        function pb(a) {
            ...
            }).append(o.removeAttr("id").css("margin-left", 0).append(b.children("tfoot")))).append("bottom" === j ? g :
                null));
            var b = c.children(),
                n = b[0],
                f = b[1],
        ...
        function Ca(a) {
            ...
            if (!n && !f && !e && j == Z(a) && j == i.length)
                ...
                for (k = 0; k < d.length; k++) l = c[d[k]], i[k].style.width = null !== l.sWidthOrig && "" !== l.sWidthOrig ?
                    s(l.sWidthOrig) : "";
                if (a.aoData.length)
                    for (k = 0; k < d.length; k++) n = d[k], l = c[n], h(Db(a, n)).clone(!1).append(l.sContentPadding).appendTo(p);
                j.appendTo(m);
        ...
        q.prototype = {
            ...
            iterator: function(a, b, c) {
                var d = [],
                    e, f, g, h, i, o = this.context,
                    m, n, k = this.selector;
                "string" === typeof a && (c = b, b = a, a = !1);
                f = 0;
                for (g = o.length; f < g; f++)
                    if ("table" === b) e = c(o[f], f), e !== l && d.push(e);
                    else if ("columns" === b || "rows" === b) e = c(o[f], this[f], f), e !== l && d.push(e);
        ...
        r("cells()",
            function(a, b, c) {
                ...
                var d = this.columns(b, c),
                    e = this.rows(a, c),
                    f, g, j, i, o, m = this.iterator("table", function(a, b) {
                        f = [];
                        g = 0;
        ...
        r("destroy()", function(a) {
            ...
            return this.iterator("table", function(b) {
                ...
                c = h.inArray(b, p.settings); - 1 !== c && p.settings.splice(c,
                    1)
            })
        });
        p.version = "1.10.1";
