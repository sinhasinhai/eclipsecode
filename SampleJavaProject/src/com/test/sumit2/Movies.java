...
public class Movies {
	...
	// checking the user input what user is selecting
	private static void checkUserInput(Movies m, Scanner in, int s) {

		switch (s) {

		case 1://if one is selected enter the movie number
		...
		case 2://if second is selected enter the movie name for search
		...
		case 3://if third is selected enter part of movie name for search
	...
	// showing the funtion of 1,2,3,4,5,6,7
	...
	//fuction for searching part of movies
