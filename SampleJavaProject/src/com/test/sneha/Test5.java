 ...
 */
// 2. Please define with a proper class name, ex: SequenceSearch
public class Test5 {
	...
	public static void main(String[] args) {
		//8. Remove the auto generated comment. If not removed, it states that the code implementation is incomplete.
